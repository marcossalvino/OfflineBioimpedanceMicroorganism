...
file_list=dir('H:\Experimento\Dados\20160909\*.txt');
...
NewName=[filename(1:11) 'Model.dat'];
% dados=(alldata);
% save (NewName, 'k', 'Vetor_Rs', 'Vetor_Rcy', 'Vetor_Cm', 'Vetor_Cdl', '-ascii');
       
T = table(Vetor_Rs', Vetor_Rcy', Vetor_Cm', Vetor_Cdl','VariableNames',{'Rs_Ohms'  'Rcy_Ohms'  'Cm_uF'  'Cdl_uF'});
