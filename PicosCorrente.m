...
dir E:\Experimento\Dados\20151214;
...
NewName=[filename(1:end-24) '.txt'];
tempoA=[0:5:length(vetor_picos)];
% dados=[tempoA  vetor_picos];
% save (NewName, 'tempoA', 'vetor_picos', '-ascii');

T = table(tempoA', vetor_picos','VariableNames',{'Tempo (s)'  'Corrente (mA)'});
