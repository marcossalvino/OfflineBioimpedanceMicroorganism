...
Tempo = [1 2 3 4 5 6 8 9 10 12];
tempo=Tempo;
Viaveis = [42 156 61 171 130 170 196 278 167 203];
Nviaveis = [3 39 12 21 21 19 31 55 47 56];
Totais = Viaveis + Nviaveis;
Diluicao = [1 1 2 2 4 4 4 4 4 4];
...
Tempo2=[1 2 3 4 5 6 8 9 10 12 13];
Tempo2=Tempo2([1:10]);
